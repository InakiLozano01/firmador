...
def get_signature_value_own(data_to_sign):
    try:
        ...
        return jsonify({"status": False, "message": "Failed to sign data locally:" + str(e)}), 500
...
def get_certificate_from_local():
    try:
        ...
        return certificate_base64, 200
    except Exception as e:
        return jsonify({"status": False, "message": "Failed to read local certificate:" + str(e)}), 500
