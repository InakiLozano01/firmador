...
def get_data_to_sign_own(pdf_bytes, certificate_data, x, y, page, name, cuit, email, current_time, datetimesigned):
    try:
        body = {
            "parameters": {
                "signingCertificate": {
                    "encodedCertificate": certificate_data['certificate']
                },
                "certificateChain": [
                    {"encodedCertificate": cert} for cert in certificate_data['certificateChain']
                ],
...
def sign_document_own(pdf_bytes, signature_value, certificate_data, x, y, page, name, cuit, email, current_time, datetimesigned):
    try:
        body = {
            "parameters": {
                "signingCertificate": {
...
def get_data_to_sign_tapir(pdf_bytes, certificate_data, x, y, page, name, cuil, email, current_time, datetimesigned):
    try:
        body = {
            "parameters": {
                "signingCertificate": {
...
def sign_document_tapir(pdf_bytes, signature_value, certificate_data, x, y, page, name, cuil, email, current_time, datetimesigned):
    try:
        body = {
            "parameters": {
                "signingCertificate": {
